      ...
      <div className="container px-4 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-6xl font-bold text-primary-foreground mb-4">
            The Year in <em className="text-gradient-hero not-italic">Motion</em>
          </h2>
          <p className="text-primary-foreground/70 max-w-xl mx-auto">
            Press play and relive the moments that defined this incredible journey.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mt-6 text-primary-foreground/70 text-sm">
            ...
            <span>A tribute reel made with love</span>
          </div>
        </motion.div>
      </div>
    </section>
